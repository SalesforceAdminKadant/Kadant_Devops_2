({	
    ...
    init: function(component, event, helper) {
        ...
        if(docid!=''){ 
        	component.set("v.DocRecordId",docid);
            component.set("v.DocCustomerId",cusid);
            
            var action = component.get('c.getQuoteDetailsPage2');
    ...
    openPage1: function(component, event, helper) {
        ...
        var recordTypeId = component.get("v.quoteRecord[0][1]");
        console.log("Recid=");
        console.log(recordTypeId);
        
        //Set tabset to minimal for KCD, KSA, NML, KJ, VK
        if (recordTypeId=='0120z000000UQ3gAAG'||recordTypeId=='0124W0000015fSfQAI'||recordTypeId=='0124W0000016T0IQAU'||recordTypeId=='0120z000000UQ5wAAG'||recordTypeId=='0124W000001AitLQAS'){
    ...
    openPage2: function(component, event, helper) {
        ...
        var StandardLeadTime = component.get("v.quoteRecord[0][4]");
    ...
    closePages: function(component, event, helper) {
     	...
     	var DocRecordId = component.get("v.DocRecordId");         
        var DocCustomerId = component.get("v.DocCustomerId");
		...
		if ($A.util.isArray(lineLT)) {
    		lineLT.forEach(cmpLT => { 
            	quoteLT.push({value:cmpLT.get("v.value"), key:cmpLT.get("v.name")});
            })
		} else {
    			quoteLT.push({value:lineLT.get("v.value"), key:lineLT.get("v.name")});
		}
        //console.log('LT info: ');
                //console.log(quoteLT);
        ...
        ReloadPageUrl.setParams({"url": "/quote?page=quo&docid="+DocRecordId+"&cusid="+DocCustomerId+"&tabset-5ecad=2"});
       	ReloadPageUrl.fire();
    ...
    cancelPages: function(component, event, helper) {
        ...
        var ReloadPageUrl = $A.get("e.force:navigateToURL");
        eloadPageUrl.setParams({"url": "/quote?page=quo&docid="+DocRecordId+"&cusid="+DocCustomerId});
        ReloadPageUrl.fire();
   	},
