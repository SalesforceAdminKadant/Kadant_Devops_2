({
	...
	{
		console.log("UMachineSectionMap: initComponent at " + window.location.origin);
		...
		component.set("v.iframeSrc", "/apex/Machine_Section_Map?id=" + rec + "&lcHost=" + lch + "&retURL=" + ret);

		window.addEventListener("beforeunload", $A.getCallback(function(event)
		{
			console.log("UMachineSectionMap: beforeunload");
