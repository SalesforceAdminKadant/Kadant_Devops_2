({
	onLoad : function(component, event, helper) {
        	...
        	//userId='00560000003g6mHAAQ'; // Marcel en Emma - ID Marcel
        	//userId='0050z0000080jIqAAI'; //EU ESC Romania
        	//userId='0050z0000080jIbAAI'; //The Nippon Joint, Ltd';}
        	//userId='0050z000006zvCoAAI'; //Brain Box';}
        	//userId='0050z0000080VHjAAM'; //Gentech Engineering Plastics';}

        	component.set("v.CurrentUser", userId);
        	
        	var today = new Date();
			var OrderScope = today.getFullYear();
        	//OrderScope = '2019';
        	component.set("v.OrderScope",OrderScope);
        	console.log('jaar='+OrderScope);
