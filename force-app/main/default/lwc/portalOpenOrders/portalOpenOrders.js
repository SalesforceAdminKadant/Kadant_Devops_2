...
import getOpenOrders from '@salesforce/apex/PortalController.getOpenOrders';
import Id from '@salesforce/user/Id'; 

export default class PortalOpenOrders extends LightningElement {
    userId = Id; 
    latestActions = [];
    sortBy;
    sortDirection;
    ...
    @wire(getOpenOrders, { acctId: '$acctId'}) 
