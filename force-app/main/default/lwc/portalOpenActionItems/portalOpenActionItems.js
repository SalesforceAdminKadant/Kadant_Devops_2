...
export default class PortalOpenActionItems extends LightningElement {
    userId = Id;
    @track acctId;
    @track topics = [];
    ...
    @track columns = [
        ...
        { label: 'Priority', fieldName: 'Priority__c', type: 'text', editable: false, initialWidth: 120, sortable: true, hideDefaultActions: true },
        { label: 'Position', fieldName: 'Position__c', type: 'text', editable: false, initialWidth: 250, sortable: true, hideDefaultActions: true },
        { label: 'Topic', fieldName: 'Topic__c', type: 'text', editable: false, initialWidth: 120, sortable: true, hideDefaultActions: true },
        { label: 'Date', fieldName: 'CreatedDate', type: 'date', editable: false, initialWidth: 150, sortable: true, hideDefaultActions: true,
            typeAttributes:{
                month: "short",
                day: "2-digit",
                year: "numeric"
        ...
        { label: '', fieldName: '', type: 'text', initialWidth: 80, editable: false, sortable: false, hideDefaultActions: true },
    ]; 
    ...
    @wire(getOpenServiceTopics, {acctId: '$acctId', maxRecords: 200}) 
    wiredTopics({ error, data }) {
        if (data) {
            ...
            data.forEach((row) => {
                let rowData = {};
                rowData.Id = row.Id;
                rowData.Priority__c = row.Priority__c;
