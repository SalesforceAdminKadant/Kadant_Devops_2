trigger XFPRenameTriggerForMachineMappingCleaning on Machine_Mapping_Cleaning__c (after Update)
{
    if(!Test.isRunningTest())
        XFILES.XFPRenameFolders.handlePathUpdate(trigger.old, trigger.new, 'Machine_Mapping_Cleaning__c');
    else
    {
