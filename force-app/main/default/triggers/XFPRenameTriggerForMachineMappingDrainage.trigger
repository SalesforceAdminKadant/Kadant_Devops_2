trigger XFPRenameTriggerForMachineMappingDrainage on Machine_Mapping_Drainage__c (after Update)
{
    if(!Test.isRunningTest())
        XFILES.XFPRenameFolders.handlePathUpdate(trigger.old, trigger.new, 'Machine_Mapping_Drainage__c');
    else
    {
