trigger XFPRenameTriggerForMachineMappingBelt on Machine_Mapping_Belt__c (after Update)
{
    if(!Test.isRunningTest())
        XFILES.XFPRenameFolders.handlePathUpdate(trigger.old, trigger.new, 'Machine_Mapping_Belt__c');
    else
    {
