trigger XFPRenameTriggerForMachineMappingFilter on Machine_Mapping_Filter__c (after Update)
{
    if(!Test.isRunningTest())
        XFILES.XFPRenameFolders.handlePathUpdate(trigger.old, trigger.new, 'Machine_Mapping_Filter__c');
    else
    {
