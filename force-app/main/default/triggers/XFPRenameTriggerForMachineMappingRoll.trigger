trigger XFPRenameTriggerForMachineMappingRoll on Machine_Mapping_Roll__c (after Update)
{
    if(!Test.isRunningTest())
        XFILES.XFPRenameFolders.handlePathUpdate(trigger.old, trigger.new, 'Machine_Mapping_Roll__c');
    else
    {
